...
public class ResultManager : MonoBehaviour {
    ...
    void DelayYouAreRight()
    {
        ...
        Invoke("ResetTheViewEveryTest", 1.5f);
    }
    ...
    public void YouAreWrong()
    {
        ...
        Invoke("WrongToDelayDestoryAndReset", 2f);
    }

    void WrongToDelayDestoryAndReset()
    {
        ObjectManager.Instance.DestoryBallon();
        Invoke("ResetTheViewEveryTest", 2f);
    }
    ...
    public void ResetTheViewEveryTest()
    {
        ...
        if (SceneManager.GetActiveScene().name.Equals("Scene5(Find)"))
        {
            ...
            if (InitGameManager.Instance.id < LevelManager.Instance.questionCount) 
            {
                InitGameManager.Instance.GameAgain(LevelManager.Instance.objectNumber, InitGameManager.Instance.level, LevelManager.Instance.maxGameTime, LevelManager.Instance.questionCount, LevelManager.Instance.boomCount, LevelManager.Instance.daoJuCount, LevelManager.Instance.dissappearTime, LevelManager.Instance.isRotate);
            }
    ...
    public void ClearTheViewEveryTest()
    {
        ...
        //取消摆设物体的展示    
        Destroy(BalletManager.Instance.foodShow.gameObject);
        GameManager.instance.SomethingStop();
    ...
    public void ClearTheViewEveryLevel()
    {
        ...
        AnswerManager.Instance.ClearScoreNumber();  //清除计分，好乱啊
